...
removeRepAlign <- function(refSpecGenome, queSpecGenome, refSpec, queSpec, alignPath = "../accesoryFiles/Data/usable_alignmnet/"){
  ...
  align <- read.table(paste(alignPath,refSpecGenome,".",queSpecGenome,".axt.txt", sep = ""), 
