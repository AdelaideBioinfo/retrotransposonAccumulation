...
col1 = "darkorange"
col2 = "aquamarine4"
pdf(file = paste("~/Desktop/Domain_manuscript/plots/Fig1/colourTest/ancPCAcircos_", col1, "_", col2,".pdf", sep = ""),onefile = T)
...
pdf(file = paste("~/Desktop/Domain_manuscript/plots/Fig1/colourTest/newPCAcircos_", col1, "_", col2,".pdf", sep = ""),onefile = T)
